...
humandate: "August 17 & 18, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:45 am - 5:00 pm CDT (13:45 pm - 10:00 pm UTC)<br><a href = 'https://forms.gle/XCfdLtBiqD7f537N9'>Application link</a>"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-08-17      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-08-18        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Auriel Fournier", "Elizabeth Wickes", "Felipe Menanteau", "Isaac Overcast"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Geoff Ower", "Matt Yoder", "Emily Benton", "Deborah Paul (as Lead Organizer)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["wickes1@illinois.edu","auriel@illinois.edu", "dlpaul@illinois.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2026-08-17-inhs
